const quizQuestions = [
    {
      ...
      options: ["Dr. B. R. Ambedkar", "Dr. Rajendra Prasad", "Mahatma Gandhi", "Swami Vivekananda"],
    ...
    },
    {
      ...
      options: ["Punjab", "Bihar", "Goa", "Mizoram"],
      correctAnswer: "Goa"
    },
    {
      question: "Most widely spoken language in the world is?",
      options: ["English", "Chinese", "Hindi", "Spanish"],
      correctAnswer: "Chinese"
    },
    {
      question: "Which is the longest river on the earth?",
      options: ["Amazon River",  "Nile", "Yangtze River", "Yellow River"],
      correctAnswer: "Nile"
    }
  ];
